...
functions = [linear, exponential, cubic, quartic, a_to_x, sqrt, cbrt, normal, neg_normal, laplace, cauchy, sinusoidal,
...
class AutoCurver(BaseEstimator):
    def __init__(self, max_params=8, maxfev=100000, certainty_scaler=1):
